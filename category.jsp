				...
				<!--//End-banner-->
					...
					<!--//pop-up-box -->
								...
								<div class="tittle-head">
									<h3 class="tittle">All Category<span class="new">New</span></h3>
								...
								<div class="col-md-3 content-grid">
                                                                    <a href="single_category.jsp?category_id=<%=category_id%>"><img src="user/Artist/<%=category%>.jpg" width="180px" height="180px"> <%=category%> Songs </a>
