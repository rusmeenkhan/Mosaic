			...
			<div id="page-wrapper">
				...
				<div class="inner-content single">
						...
						<div class="tittle-head">
                                                                        ...
                                                                        <div class="col-md-4"> 
                                                                              <img src="user/music/<%=albumid%>.jpg" width="180px" height="180px">
                                                                        </div>		
                                                                        <div class="col-md-4">
                                                      ...
                                                      <tr>
                                                          <%
                                                            ...
                                                            Statement st1=cn1.createStatement();
                                                             ResultSet rs1= st1.executeQuery("select * from favourite where email='"+email+"' AND favourite=1 AND songId='"+songid+"'");
                                                             if(rs1.next()){
                                                          %>
                                                        <td><span class="glyphicon glyphicon-heart" style="color:red" id="<%=songid%>" style="cursor:pointer"></span></td>
                                                        <%
                                                          }
                                                         else
                                                        {
                                                        %>
                                                        <td><span class="glyphicon glyphicon-heart" style="color:black" id="<%=songid%>" style="cursor:pointer"></span></td>
                                                       <% }
                                                        %>
                                                        <td><%=tittle%></td>
                                                        <td><%=Artist%></td>
                                                        <td><a href="single.jsp?songid=<%=songid%>&&albumid=<%=albumid%>"><button class="btn btn-primary">Play</button></a></td>
                                                      </tr>
                                                    </tbody>
                                                    <%
                                                      }
