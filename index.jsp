									...
									<div class="sign-right">
										<form action="insert.jsp" method="post">
											<h3>Create your account </h3>
                                                                                        <input type="text" value="First Name" name="fname" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}" required="">
											<input type="text" value="Last Name" name="lname" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}" required="">
											<input type="text" value="Mobile number" name="mob" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Mobile number';}" required="">
											<input type="text" value="Email id" name="email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email id';}" required="">	
											<input type="password" Placeholder="Password" name="pass" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required="">	
											<input type="password" Placeholder="Retype Password" name="repass" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required="">	
				...
				<!--//End-banner-->
					...
					<!--//pop-up-box -->
						<div class="albums">
								...
								<a href="single.jsp?albumid=<%=albumid%>">Listen now</a>	
							</div>
                                                                <%
                                                                    }
                                                                %>
