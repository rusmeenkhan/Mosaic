						...
						<div class="tittle-head">
                                                                        ...
                                                                        <%                                            
                                                                          try{
                                                                                ...
                                                                                ResultSet rs=st.executeQuery("select * from song where category_code='"+category_id+"'");
                                                                                if(rs.next()){
                                                                                  String category =rs.getString("category");  

                                                                                %>
                                                                              <img src="user/Artist/<%=category%>.jpg" width="180px" height="180px">
                                                                              <%
                                                                              }
                                                                              %>
                                                                        </div>		
                            ...
                            <%  
                                           ResultSet rs1=st.executeQuery("select * from song where category_code='"+category_id+"'");
                                           while(rs1.next())
                                           { 
                                             String  tittle=rs1.getString("tittle");
                                             albumid=rs1.getString("albumid");
