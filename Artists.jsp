									...
									<div class="clearfix"> </div>
                                                    ...
                                                    <%
                                                                 ...
                                                                 Statement st=cn.createStatement();            
                                                                    ResultSet rs=st.executeQuery("select distinct Artist from song limit 12"); 
                                                                    while(rs.next())
                                                                      {   
                                                        ...
                                                        %>
								<div class="col-md-4">
                                                                    <a href="single_Artist.jsp?Artist=<%=Artist%>"><img src="user/Artist/<%=Artist%>.jpg" width="180px" height="180px"> <%=Artist%> </a>
