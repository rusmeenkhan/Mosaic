			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li><a href="Artists.jsp"><i class="lnr lnr-users"></i> <span>Artists</span></a></li> 
						<li><a href="Albums.jsp"><i class="lnr lnr-music-note"></i> <span>Albums</span></a></li>						
						<li><a href="Favourities.jsp"><i class="lnr lnr-heart"></i>  <span>My Favourities</span></a> 
						</li>
							...
							<div class="banner-section">
								<div class="banner">
                                                                        <div class="col-sm-5 col-sm-offset-3 col-md-6 col-md-offset-2 main">
                                                                               <center> <h1>Edit Song</h1></center>
                                                                               <form method="post" action="update_song.jsp?songid=<%=songid%>" class="panel-body wrapper-lg">
                                                                                            <%
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                          ...
                                                                                          <input type="text" value="<%=tittle%>" name="tittle" class="form-control input-lg">
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                          <label class="control-label"> Artist</label>
                                                                                          <input type="text" value="<%=Artist%>" name="Artist" class="form-control input-lg">
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                          <label class="control-label"> Description</label>
                                                                                          <input type="text" value="<%=Description%>" name="Description"  class="form-control input-lg">
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                           ...
                                                                                           <select name="albumname">
                                                                                            ...
                                                                                            <%
                                                                                               ResultSet rs2=st.executeQuery("select * from album");
                                                                                               while(rs2.next()){
