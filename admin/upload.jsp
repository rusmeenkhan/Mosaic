							...
							<div class="banner-section">
								<div class="banner">
                                                                        <div class="col-sm-5 col-sm-offset-3 col-md-6 col-md-offset-2 main">
                                                                               <center> <h1>Upload New song</h1></center>
                                                                                <form method="post" action="insertsong.jsp" class="panel-body wrapper-lg">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                          ...
                                                                                          <input type="text" name="Artist" class="form-control input-lg">
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                          <label class="control-label"> Description</label>
                                                                                          <textarea  name="Description" cols="50" rows="3"  class="form-control input-lg"></textarea>
                                                                                        </div>
                                                                                        <div class="form-group">
