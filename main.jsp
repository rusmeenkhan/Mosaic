				      ...
				      <div class="music-left">
					      <!--banner-section-->
							<div class="banner-section">
								<div class="banner">
									 <div class="callbacks_container" id="rusmeen">
										<ul class="rslides callbacks callbacks1" id="slider4">
											   	<li>
														...
														<div class="banner-info">
														              <a class="trend" href="index.jsp">TRENDING</a>
																	  <h3>Let Your Home</h3>
				...
				<!--//End-banner-->
					...
					<!--//pop-up-box -->
						<div class="albums" >
								<div class="tittle-head">
									...
									<div class="clearfix"> </div>
                                                    ...
                                                    <%
                                                                 ...
                                                                 ResultSet rs=st.executeQuery("select * from album where status=1 limit 6");
                                                                 while(rs.next())
                                                                    {   
								...
								<div class="col-md-4 content-grid">
                                                                    ...
                                                                    <a href="single.jsp?albumid=<%=albumid%>"> <img src="user/music/<%=albumid%>.jpg" width="150px" height="150px"><%=tittle%> </a>
					...
					<!--//End-albums-->
						<!--//discover-view-->
                                                <div class="col-md-6">
						  <ul class="pager">
                                                    <li id="Previous" class="btn btn-primary"><a href="#">Previous</a></li> 
                                                  </ul>
                                                </div>
                                                <div class="col-md-6">
						    <ul class="pager">  
