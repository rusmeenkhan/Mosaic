			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li><a href="Favourites.jsp"><i class="lnr lnr-heart"></i>  <span>My Favourites</span></a> 
						</li>
				...
				<!--//End-banner-->
					...
					<!--//pop-up-box -->
								...
								<div class="tittle-head">
									<h3 class="tittle">My Favourites<span class="new">New</span></h3>
									...
									<div class="clearfix"> </div>
                                                    ...
                                                    <%
                                                                 ...
                                                                 ResultSet rs1=st.executeQuery("select * from favourite where email='"+email+"' AND favourite=1");
                                                                 while(rs1.next())
                                                                 {
                                                                 ...
                                                                 Statement st1=cn1.createStatement();            
                                                                    ResultSet rs=st1.executeQuery("select * from song where songId='"+songid+"'"); 
                                                                    while(rs.next())
                                                                      {   
                                                        ...
                                                        %>
								<div class="col-md-3">
                                                                    <a href="single_song.jsp?songid=<%=songid%>&&albumid=<%=albumid%>"><img src="user/music/<%=albumid%>.jpg" width="180px" height="180px"> <%=tittle%> </a>
					...
					<!--//End-albums-->
						...
						<div class="col-md-6">
						  <ul class="pager">
                                                    <li class="btn btn-primary"><a href="#">Previous</a></li> 
                                                  </ul>
                                                </div>
                                                <div class="col-md-6">
						    <ul class="pager">  
                                                      <li class="btn btn-danger"><a href="#">Next</a></li>
                                                    </ul>
                                                </div>
							...
							<!--//music-left-->
						    <!--/music-right--> <div class="music-right">
								<!--/video-main-->
