 ...
 <%    String email=null;
    ...
    <section>
 	 ...
 	 <!-- /w3l-agileits -->
        ...
        %>    
                                                <div class="col-md-6">
                                                    <center>  <h2 style="margin-top: 25px"> My Profile</h2></center>
	                                                                        <form action="insert.jsp" method="post">
                                                                                    First Name <input type="text" class="form-control" value="<%=fname%>" name="fname" disabled><br>
									             Last Name<input type="text"  class="form-control" value="<%=lname%>" name="lname" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}" disabled=""><br>
									             Mobile<input type="text" value="<%=mob%>"  class="form-control" name="mob" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Mobile number';}" disabled=""><br>
									      	     Email<input type="text" value="<%=email%>"  class="form-control" name="email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email id';}" disabled=""><br>	
										</form>
                                                                    </div>
                                                                  <div class="col-md-3">
                                              </div>
