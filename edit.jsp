 ...
 <%    String email=null;
    ...
    <section>
 	 ...
 	 <!-- /w3l-agileits -->
        ...
        %>    
                                                <div class="col-md-6">
                                                    <center>  <h2 style="margin-top: 25px"> Edit Profile</h2></center>
	                                                                        <form action="update.jsp" method="post">
                                                                                    First Name <input type="text" class="form-control" value="<%=fname%>" name="fname"  required=""><br>
									             Last Name<input type="text"  class="form-control" value="<%=lname%>" name="lname"  required=""><br>
									             Mobile<input type="text" value="<%=mob%>"  class="form-control" name="mob"  required=""><br>
